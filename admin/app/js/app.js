...
var App = angular.module('divine', ['angular-img-cropper','ngRoute', 'ngAnimate', 'ngStorage', 'ngCookies', 'pascalprecht.translate', 'ui.bootstrap', 'ui.router', 'oc.lazyLoad', 'cfp.loadingBar', 'ngSanitize', 'ngResource', 'ui.utils', 'chart.js', 'ng-fusioncharts','ui.mask'])
        ...
        function ($rootScope, $scope, $state, $translate, $window, $localStorage, $timeout, toggle, colors, browser, cfpLoadingBar, $cookieStore) {
            ...
            $rootScope.$on('$stateNotFound',
                function (event, unfoundState, fromState, fromParams) {
                    ...
                    con
                    sole.log(unfoundState.toParams); // {a:1, b:2}
