var myApp = angular.module('BlowLtd', ['blow-ltd','angularPayments']);

myApp.run(["$log", function ($log) {
}]);

App.constant("MY_CONSTANT", {
    "url": "http://52.6.133.251:2601",
    "CATEGORY1": "Blow Dry",
    "CATEGORY2": "Makeup",
    "CATEGORY3": "Nails",
    "CATEGORY4": "Packages",
...
myApp.config(['$stateProvider', '$locationProvider', '$urlRouterProvider', 'RouteHelpersProvider',
    function ($stateProvider, $locationProvider, $urlRouterProvider, helper) {
        ...
        window.Stripe.setPublishableKey('pk_test_rqQYt1cmUkEZKFIuHS4ji2ec');
        ...
        $stateProvider
            ...
            .state('app.verified-artist', {
                ...
                resolve: helper.resolveFor('datatables', 'datatables-pugins', 'ui.select', 'taginput', 'inputmask', 'moment', 'localytics.directives', 'slider')
            })
            ...
            .state('app.looks', {
                url: '/looks',
                title: 'Look Services Information',
